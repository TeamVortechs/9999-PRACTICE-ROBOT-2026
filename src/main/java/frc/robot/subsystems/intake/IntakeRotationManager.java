...
public class IntakeRotationManager {
   ...
   */
  public IntakeRotationManager(Supplier<Pose2d> targetPose, Supplier<Pose2d> robotPose) {
   ...
   */
  public static double convertDistToIntakeAngle(double distance) {
    return 0;
  }
}
